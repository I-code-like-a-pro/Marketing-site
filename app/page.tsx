...
const AppScreen2: FC = () => {
  const bars: BarDay[] = [
    ...
    { height: 0.5, day: "W" }, { height: 0.9, day: "T" },
...
const PLANS: Plan[] = [
  {
    ...
    cta: "Get Started", color: PALETTE.textMuted, highlighted: false,
  },
  {
    ...
    cta: "Start Free Trial", color: PALETTE.accent, highlighted: true,
  },
  {
    name: "Team", price: "$29", per: "per team/month",
      ...
      <div style={{
        ...
        <div style={{ flex: 1, maxWidth: isMobile ? "100%" : 560, textAlign: isMobile ? "center" : "left" }}>
          ...
          <h1 style={{
            ...
            Build habits<br />
            <span style={{ background: `linear-gradient(135deg, ${PALETTE.accent}, ${PALETTE.teal})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              that actually
            </span>
            <br />stick.
          </h1>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 8, marginTop: 16 }}>
            {[0, 1, 2].map(i => (
              <div
                ...
                style={{ width: i === activeScreen ? 20 : 6, height: 6, borderRadius: 3, background: i === activeScreen ? PALETTE.accent : PALETTE.textDim, cursor: "pointer", transition: "all 0.3s" }}
              />
            ))}
          </div>
...
const LogoStrip: FC = () => (
  <div style={{ background: PALETTE.ink, borderTop: `1px solid ${PALETTE.border}`, borderBottom: `1px solid ${PALETTE.border}`, padding: "28px 0", overflow: "hidden" }}>
    ...
    <div style={{ display: "flex", gap: 60, animation: "scroll 20s linear infinite", whiteSpace: "nowrap", width: "max-content" }}>
      {[...LOGOS, ...LOGOS].map((l, i) => (
